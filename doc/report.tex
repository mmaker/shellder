...
\begin{itemize}
\item per valori di $b$ positivi l'algoritmo degenera in un \emph{round-robin}, ossia ai processi vengono assegnati eguali \emph{time-slices}, senza alcuna forma di prioritizzazione:
\begin{gather}
t, t'\ |\ t > t'
